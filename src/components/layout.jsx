            ...
            {user && (
              <Menu>
                <MenuButton
                  ...
                  fontWeight="semibold"
                  fontSize="md"
                  bgGradient="linear(to-r, gray.300, blue.200, green.300)"
                >
                  <HStack>
                ...
                <MenuList>
                  <MenuItem
                    ...
                    onClick={() => {
                      window.open(
                        `https://etherscan.io/address/${user.idToken.wallet_address}`,
                        "_blank"
                      );
                    }}
                  >
                  ...
                  <MenuItem icon={<FiLogOut />} onClick={() => setUserState()}>
                    Logout
                  </MenuItem>
                </MenuList>
              </Menu>
